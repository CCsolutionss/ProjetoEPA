 ...
 * 
 * Reusable formatting functions for dates, numbers, and other data types.
 */
...
/**
 * Get current date/time formatted for Brazil (DD/MM/YYYY - HH:MM)
 * @returns {string} Current formatted date/time
 */
...
/**
 * Format number with Brazilian locale (thousands separator)
...
/**
 * Convert ISO datetime to input datetime-local format (YYYY-MM-DDTHH:mm)
 * @param {Date | string} date - Date to convert
